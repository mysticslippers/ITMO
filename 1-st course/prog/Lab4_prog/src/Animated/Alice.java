...
public class Alice extends King implements TimeSkipable, Considerable, Learnable, NotToBeable{
    ...
    public String arrive(){
        anonymousReachable(new Reachable(){
            @Override
            public void reach() throws DistanceOutOfRangeException{
                int distance = 50;
